# Local training pipeline for "Brainchip / Image Classification project using BrainChip MetaTF and Akidanet models"

This is the local training pipeline (based on Keras / TensorFlow) for your Edge Impulse project [Brainchip / Image Classification project using BrainChip MetaTF and Akidanet models](http://localhost:4800/studio/134706) (http://localhost:4800/studio/134706). Use it to train your model locally or run experiments. Once you're done with experimentation you can push the model back into Edge Impulse, and retrain from there.
